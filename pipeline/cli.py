...
from pipeline.pipeline_config import CLEAN_CSV, INPUT_CSV
...
@click.option("--input-csv", default=INPUT_CSV, help="Path to input csv")
@click.option("--output-csv", default=CLEAN_CSV, help="Path to output csv")
def run_full(
...
@click.option("--input-csv", default=CLEAN_CSV, help="Path to input csv")
